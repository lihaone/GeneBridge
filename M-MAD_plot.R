...
# species <- 'human'
#
# mmad_module_plot(data, pathway.pos, pathway.names, species, thres=0.268)

mmad_module_plot <- function(data, pathway.pos, pathway.names, species, thres=0.268){
  ...
  plot(data$pos, data$mean.w, pch=19, cex=data$size, ylim=c(ymin,ymax), col=data$color, xlab='Modules', ylab='MMAS', xaxt='n',yaxt='n',
